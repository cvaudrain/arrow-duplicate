...
export default function About(props){
    ...
    return(
        ...
        <div className="mclaren">
            ...
            <div className="title-card cloud-gradient theGoodShading top-space-sm blue">
        <div className="centered">
        <h4 className="">About The App</h4>
        </div>
        </div>
        <div className="title-card indigo-gradient theGoodShading top-space-sm">
        <div className="centered">
        <p style={{fontSize:"1.2rem"}}>Here you'll find an assortment of cohesive apps designed to assist with productivity and self-reflection. There are currently several core features designed to give you a personalized and hopefully fun experience. </p>
        </div>
        </div>

        {/*  */}
        <div className="title-card peach-gradient theGoodShading top-space-sm blue">
        <div className="centered">
        ...
        <div className="title-card indigo-gradient theGoodShading top-space-sm">
        <div className="centered">
        <p style={{fontSize:"1rem",padding:"15px"}}>Your homepage where you can see the day at a glance. Take notes, view the events of the day and quickly log a journal entry from here </p>
        </div>
        </div>
        {/*  */}
        <div className="title-card cloud-gradient theGoodShading top-space-sm blue">
        ...
        <div className="title-card indigo-gradient theGoodShading top-space-sm">
        <div className="centered">
        <p style={{fontSize:"1rem",padding:"15px"}}>A tool to write out your thoughts and optionally track your state of mind each day. Record values for your sense of calm, focus, mood and motivation on a sliding scale. These personal, subjective measures are primarily for self-reflection, though to add a bit of a fun twist, these values also contribute to your rolling 'stats' and 'power level', in an RPG/video game style. </p>
        </div>
        </div>
        ...
        <div className="title-card indigo-gradient theGoodShading top-space-sm">
        <div className="centered">
        <p style={{fontSize:"1rem",padding:"15px"}}>A scheduler based on the <a href="https://www.npmjs.com/package/react-calendar"> React Calendar </a> to view your monthly schedule at large, developed further to set daily events hour-by-hour. Current daily events are also visible on the dashboard. </p>
        </div>
        </div>
        ...
        <div className="title-card indigo-gradient theGoodShading top-space-sm">
        <div className="centered">
        <p style={{fontSize:"1rem",padding:"15px"}}>Your profile is a place where you can view your accumulated "stats", "rank", set a profile picture, and change account settings. Stats are just for some stylized fun, and are increased over time the more you journal. </p>
        </div>
        </div>
        <div className="title-card cloud-gradient theGoodShading top-space-sm blue">
        <div className="centered">
